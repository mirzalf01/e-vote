        ...
        <div class="card-body">
            ...
            @csrf
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputName1" aria-describedby="nameHelp" placeholder="Name" name="name" value="{{ old('name') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Confirm Password" aria-describedby="passwordConfirmationHelp" name="password_confirmation">
                </div>
                <div class="form-group">
                    <button class="btn w-100" type="submit">Register</button>
                </div>
            </form>
            <p>Have an account?<a href="{{ route('login') }}">Click here</a> to Sign in</p>
        </div>
    </div>
    {{-- Bootstrap JS --}}
